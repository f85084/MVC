...
namespace OnlineGame.Web.Controllers
{
    public class GamerController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Gender,City,DateOfBirth,EmailAddress,Score,ProfileUrl,GameMoney,TeamId,RolePhoto,RolePhotoAltText")] Gamer gamer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Gender,City,DateOfBirth,EmailAddress,Score,ProfileUrl,GameMoney,TeamId,RolePhoto,RolePhotoAltText")] Gamer gamer)
        {
            if (ModelState.IsValid)
            {
