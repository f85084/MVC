...
IF ( EXISTS ( SELECT    *
              FROM      INFORMATION_SCHEMA.TABLES
              WHERE     TABLE_NAME = 'SingleSelect' ) )
    BEGIN
        TRUNCATE TABLE SingleSelect;
        DROP TABLE SingleSelect;
    END;
GO -- Run the previous command and begins new batch
IF ( EXISTS ( SELECT    *
              FROM      INFORMATION_SCHEMA.TABLES
              WHERE     TABLE_NAME = 'MultipleSelect' ) )
    BEGIN
        TRUNCATE TABLE MultipleSelect;
...
GO -- Run the previous command and begins new batch
INSERT  SingleSelect
VALUES  ( N'SingleSelect Item A', 0);
INSERT  SingleSelect
VALUES  ( N'SingleSelect Item B', 1 );
INSERT  SingleSelect
VALUES  ( N'SingleSelect Item C', 0 );
GO -- Run the previous command and begins new batch
INSERT  MultipleSelect
VALUES  ( N'MultipleSelect Item A', 0);
INSERT  MultipleSelect
VALUES  ( N'MultipleSelect Item B', 0 );
INSERT  MultipleSelect
...
INSERT  MultipleSelect
VALUES  ( N'MultipleSelect Item F', 0 );
GO -- Run the previous command and begins new batch
